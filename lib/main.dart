...
class MyHomePage extends StatelessWidget {
            ...
            children: [
              Center(
                child: Column(
                  ...
                  children: <Widget>[
                    _showTodayCounter(context, model),
                    _showButton(context, model),
                  ],
                ),
              ),
            ],
  ...
  _showTodayCounter(BuildContext context, MainModel model) => Container(
        child: Padding(
  ...
  _showButton(BuildContext context, MainModel model) => Padding(
                            ...
                            return CupertinoAlertDialog(
                              ...
                              actions: <Widget>[
                                ...
                                CupertinoDialogAction(
                                  ...
                                  onPressed: () {
                                    //TODO レンズのカウントを−１する
                                    model.decrementLensStockAndResetStartDate();
                                    Navigator.pop(context);
                                  },
                                ),
                              ],
